...
$base_url ="http://shyamfuture.com"; //url base of site if you want only relative url leave empty Exam:> http://abc.in
$upload_dir = '/assets/admin/tinymce/source/'; // path from base_url to upload base dir Exam:> /assets/tinymce/source
