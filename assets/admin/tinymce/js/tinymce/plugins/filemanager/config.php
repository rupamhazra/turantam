...
$base_url ="http://192.168.24.208"; //url base of site if you want only relative url leave empty
$upload_dir = '/pranav/uploads/blog_content_images'; // path from base_url to upload base dir
$current_path = '../../../../../../../uploads/blog_content_images/'; // relative path from filemanager folder to upload files folder
