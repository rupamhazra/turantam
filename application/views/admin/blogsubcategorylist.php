    ...
    <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <?php
                    echo form_open(base_url() . "admin/delete-or-ac_inac-multi-sub-cat", array("class" => "form-horizontal form-label-left", "name" => "Delete_Form","id" => "mmursp_deleteForm"));
                  ?>  
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <a href="<?php echo base_url('admin/add-blog-sub-category'); ?>" class="btn btn-success pull-right">Add Sub Category</a>
                    </div>
                  </div>
                  <?php echo form_close(); ?>
               ...
               <div class="x_content">
                  ...
                  <td><input id="delete_check_id_<?php echo $row['id']; ?>" class="mmursp_delete_check_class" type="checkbox" name="delete_check[]" onclick="mmursp_each_check(<?php echo $row['id']; ?>)" value="<?php echo $row['id']; ?>">  </td>
									...
									<td><?php echo $row['parent_category_name']; ?></td>
									<td><a class="label " <?php if($row['is_active']=='active') echo 'style="color:green;"'; else echo'style="color:red;"'; ?> href="<?php echo base_url().'admin/change-blog-sub-category-status/'.$row['id']; ?>"><?php echo ucfirst($row['is_active']); ?></a></td>
									<td><a class="label brown" href="<?php echo base_url('admin/edit-blog-sub-category').'/'. $row['id']; ?>">Edit</a> <a class="label red" href="#" onclick="confirm_modal('<?php echo base_url('admin/delete-blog-sub-category').'/'.$row['id'];?>');">Delete</a>
                  </td>
