        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    echo form_open_multipart(base_url() . "admin/update-package-entity/".$package_entity['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                                ...
                                <?php
                                 ...
                                 if(count($parentList)>0){
                                  ...
                                  foreach($parentList as $row){ 
                                    if($row['id'] == $package_entity['packacge_id']) 
                                    $selected = 'selected';
                                    else
                                        $selected = '';
                    ...
                    <input type="hidden" name="edit" id="edit" value="1";>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputName" id="inputName" class="form-control cForm" value="<?php echo $package_entity['name']; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <select id="inputType" class="form-control" name="inputType">
                                   <option value="long" <?php echo ($package_entity['type'] == 'long')? $package_entity['type'] :''; ?>>long</option>
                                   <option value="short" <?php echo ($package_entity['type'] == 'short')? $package_entity['type'] :''; ?>>short</option>
                               </select>
                            </div>
                        </div>
