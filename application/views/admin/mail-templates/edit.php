        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/update-template/".$template_details['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <input id="template_code" class="form-control col-md-7 col-xs-12 cForm"  name="template_code" placeholder="" type="text" value="<?php echo $template_details['template_code']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <input type="text" id="subject" name="subject" class="form-control col-md-7 col-xs-12 cForm" value="<?php echo $template_details['subject']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <textarea id="inputContent" rows="20" class="form-control col-md-7 col-xs-12" name="content"><?php echo $template_details['content']; ?></textarea>
                        </div>
                    </div>
