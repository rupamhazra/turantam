        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/add-state", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                                ...
                                <?php
                                 if(count($countryList)>0){
                                  ...
                                  foreach($countryList as $row){ 
                                    $option .= '<option class="lavel-0" value="'.$row['id'].'">'.$row['country_name'].'</option>';
                                    ?>
                                <?php }?>
                                    <?php echo $option; ?>
                              <?php } ?>
