        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/add-master-cashback-portal/", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <input type="hidden" name="masterCashBackPortal" id="masterCashBackPortal" value="1";>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputmasterCashBackPortal" id="inputmasterCashBackPortal" class="form-control cForm" value="">
                            </div>
                        </div>
