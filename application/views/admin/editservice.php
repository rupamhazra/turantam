        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/update-service/".$service['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <p><?php
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <select name="inputServiceCategory" id="inputServiceCategory" class="form-control col-md-7 col-xs-12">
                                <?php if(count($parentList)>0){
                                  //pre($parentList,1);
                                  $option = '';
                                  foreach($parentList as $row){ 
                                    if($row['id'] == $service['category_id'])
                                        $selected = 'selected';
                                    else $selected = '';
                    ...
                    <input type="hidden" name="edit" id="edit" value="1";>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputName" id="inputName" class="form-control cForm" value="<?php echo $service['name']; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-md-12" for="title">Slug</label>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputSlug" id="inputSlug" class="form-control" readonly value="<?php echo $service['slug']; ?>">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="col-md-8 col-sm-9 col-xs-12">
                            <?php if(!empty($service['image_small'])) {?>
                            <img src="<?php echo base_url('uploads/').$service['image_small']; ?>" height="40"/>
                            <?php }else{ ?>
