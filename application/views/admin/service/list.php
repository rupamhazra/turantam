               ...
               <div class="x_content">
                  ...
                  <td><?php echo $row['category_name']; ?></td>
                      ...
                      <?php } ?>         
									...
									<td><a class="label brown" href="<?php echo base_url('admin/update-service').'/'. $row['id']; ?>">Edit</a>
                    <a class="label red" href="#" onclick="confirm_modal('<?php echo $row['id'];?>','service');">Delete</a>
                  </td>
