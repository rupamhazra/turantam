            ...
            <div class="x_panel">
                ...
                <div class="x_content">
					...
					<div class="item form-group">
                        ...
                        <input type="hidden" name="parent_slug" id="parent_slug" value="<?php echo $serviceCategory['slug']; ?>">
                                  ...
                                  foreach($parentList as $row){ 
                                    ...
                                    if(isset($row['sub_category_details'])){
                                      ...
                                      $selected ='';
                                        ...
                                        $option .= '<option class="lavel-1" slug="'.$row_s['slug'].'" value="'.$row_s['id'].'"'.$selected.'>&nbsp;&nbsp;&nbsp;'.$row_s['name'].'</option>';
                                      }
                                    }
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <?php if($locationList>0) {
                              ...
                              foreach ($locationList as $row) {
                                if(in_array($row['id'], $serviceCategory['location_id'])){
                                  $che = 'checked';
                                }else{
                                  $che = '';
                                }
                            ...
                            <input type="checkbox" name="inputLocation[]" id="inputLocation_<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>" <?php echo $che; ?>><?php echo $row['name'] ?>
                            </label>
