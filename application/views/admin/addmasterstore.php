        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/add-master-store/", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <input type="hidden" name="masterStore" id="masterStore" value="1";>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputmasterStore" id="inputmasterStore" class="form-control cForm" value="">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-md-12" for="title">Url</label>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputmasterStoreUrl" id="inputmasterStoreUrl" class="form-control cForm" value="">
                            </div>
                        </div>
