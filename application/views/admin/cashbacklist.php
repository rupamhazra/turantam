            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <?php
                    echo form_open(base_url() . "admin/delete-or-ac_inac-multi-cashback", array("class" => "form-horizontal form-label-left", "name" => "Delete_Form","id" => "mmursp_deleteForm"));
                  ?>  
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2 pull-right">
                     <a href="<?php echo base_url('admin/add-cashback') ?>" class="btn btn-success">Add Cashback</a>
                   </div>
               ...
               <div class="x_content">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"  cellspacing="0" width="100%">
                    ...
                    <tbody>
                       <?php if(count($cashbackList)>0){
						   foreach($cashbackList as $row){ ?>
							   <tr>
                  ...
                  <td><?php echo $row['cashback_portal_name']; ?></td>
                  <td><?php echo $row['cashback_type_name']; ?></td>
                  <td><?php echo $row['raw_rate_data']; ?></td>
                  <td><?php echo $row['base_rate']; ?></td>
                  <td><?php echo $row['bonus_rate']; ?></td>
                  <td><?php echo ($row['rate_type'] == '1')? '%':'$'; ?></td>
									<td><a class="label " <?php if($row['is_active']=='active') echo 'style="color:green;"'; else echo'style="color:red;"'; ?> href="<?php echo base_url().'admin/change-cashback-status/'.$row['id']; ?>"><?php echo ucfirst($row['is_active']); ?></a></td>
									<td><a class="label brown" href="<?php echo base_url('admin/update-cashback').'/'. $row['id']; ?>">Edit</a>
                    <a class="label red" href="#" onclick="confirm_modal('<?php echo base_url('admin/delete-cashback').'/'.$row['id'];?>');">Delete</a>
                  </td>
