        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/update-company/".$company['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    <input type="hidden" name="user_id" id="user_id" value="<?php echo $this->session->userdata('user_id'); ?>">
                    <p><?php
                        echo $this->session->flashdata('msg');
                        ?></p>
                    <input type="hidden" name="editCompany" id="editCompany" value="1";>
                    
    					<div class="item form-group">
                            <label class="col-md-12" for="title">Company Title</label>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputCompanyTitle" id="inputCompanyTitle" class="form-control cForm" value="<?php echo $company['name']; ?>">
                            </div>
                        </div>
