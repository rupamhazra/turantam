        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open(base_url() . "admin/update-blog-sub-category/".$blogCategory['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
					...
					<div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select name="inputParent" class="form-control col-md-7 col-xs-12">
								...
								<option value="<?php echo $row['id']?>" <?php if($row['id']== $blogCategory['cat_id']) echo 'selected="selected"'; ?>><?php echo $row['category_name']?></option>	
								<?php }} ?>
							</select>
                        </div>
                    </div>
