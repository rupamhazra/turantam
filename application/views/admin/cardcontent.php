        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/add-card", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <p><?php
                        ...
                        <label class="col-md-12" for="title">Card Category </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <select name="inputCardCategory" id="inputCardCategory" class="form-control col-md-7 col-xs-12" onChange="template_view_change(this.options[this.selectedIndex].getAttribute('template_view'));">
								<?php foreach($cardCategoryList as $row){ ?>
									<option value="<?php echo $row['id']?>" template_view ='<?php echo $row['template_view']; ?>'><?php echo $row['category_name']; ?></option>
								<?php } ?>
						   </select>
                        </div>
                    </div>
                    <input type="hidden" name="cardAdd" id="cardAdd" value="1";>
                    
    					<div class="item form-group">
                            <label class="col-md-12" for="title">Card Title </label>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputCardTitle" id="inputCardTitle" class="form-control cForm">
                            </div>
                        </div>
                        <div class="item form-group">
    					...
    					<div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                               <input type="text" name="inputCardUrl" id="inputCardUrl" class="form-control cForm">
                            </div>
                        </div>
    					<div class="item form-group">
                    ...
                    <div id="template_card_list_view" style="display: none;">
                        <div class="col-md-12">
                            <label>Add Custom Fields For Card List View</label>
                            <div class="clearfix"></div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <button id="addCardBtn" type="submit" class="btn btn-success">Save</button>
