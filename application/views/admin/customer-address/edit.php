        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/update-customer-address/".$customer_address['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                                ...
                                <?php
                                 if(count($customerList)>0){
                                  ...
                                  foreach($customerList as $row){ 
                                    if($row['id'] == $customer_address['customer_id'])
                                      $selected = 'selected';
                                    else
                                      $selected = '';
                                ...
                                <?php
                                 if(count($stateList)>0){
                                  ...
                                  foreach($stateList as $row){ 
                                    if($row['id'] == $customer_address['state_id'])
                                      $selected = 'selected';
                                    else
                                      $selected = '';
                                    $option .= '<option class="lavel-0" value="'.$row['id'].'" '.$selected.'>'.$row['state_name'].'</option>';
                                    ?>
                                <?php }?>
                                    <?php echo $option; ?>
                              <?php } ?>
          ...
          <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <textarea  name="inputAddress" id="inputAddress" class="form-control cForm"><?php echo $customer_address['address']; ?></textarea>
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-md-12" for="title">Pincode</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputPincode" id="inputPincode" class="form-control" value="<?php echo $customer_address['pincode']; ?>">
                        </div>
                    </div>
                     <div class="item form-group">
                        <label class="col-md-12" for="title">Type</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputType" id="inputType" class="form-control" value="<?php echo $customer_address['type'];?>">
                        </div>
                    </div>
