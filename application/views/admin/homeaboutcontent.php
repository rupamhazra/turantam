        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/save-home-about-content", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputTitle" id="inputTitle" class="form-control cForm">
                        </div>
                    </div>
