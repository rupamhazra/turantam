        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/update-order-details/".$order_details['id'], array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                                ...
                                <?php
                                 if(count($packageList)>0){
                                  ...
                                  foreach($packageList as $row){ 
                                    if($order_details['package_id'] == $row['id'])
                                        $selected = 'selected';
                                    else $selected = '';
                   ...
                   <div class="item form-group">
                                ...
                                <?php
                                 if(count($orderList)>0){
                                  ...
                                  foreach($orderList as $row){ 
                                    if($order_details['order_id'] == $row['id'])
                                        $selected = 'selected';
                                    else $selected = '';
                                    $option .= '<option class="lavel-0" value="'.$row['id'].'" '.$selected.'>'.$row['order_no'].'</option>';
                                    ?>
                                <?php }?>
                                    <?php echo $option; ?>
                              <?php } ?>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="number" name="inputQuantity" id="inputQuantity" class="form-control cForm" value="<?php echo $order_details['quantity']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-md-12" for="title">Unit Price</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputUnitPrice" id="inputUnitPrice" class="form-control" value="<?php echo $order_details['quantity']; ?>">
                        </div>
                    </div>
                     <div class="item form-group">
                        <label class="col-md-12" for="title">IGST</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputIGST" id="inputIGST" class="form-control" value="<?php echo $order_details['IGST']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-md-12" for="title">CGST</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputCGST" id="inputCGST" class="form-control" value="<?php echo $order_details['CGST']; ?>">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label class="col-md-12" for="title">GST</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputGST" id="inputGST" class="form-control" value="<?php echo $order_details['GST']; ?>">
                        </div>
                    </div>
