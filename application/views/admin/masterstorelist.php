            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <?php
                    echo form_open(base_url() . "admin/delete-or-ac_inac-multi-master-store", array("class" => "form-horizontal form-label-left", "name" => "Delete_Form","id" => "mmursp_deleteForm"));
                  ?>  
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2 pull-right">
                     <a href="<?php echo base_url('admin/add-master-store') ?>" class="btn btn-success">Add Store</a>
                   </div>
               ...
               <div class="x_content">
                  ...
                  <td><?php echo $row['url']; ?></td>
									<td><a class="label " <?php if($row['is_active']=='active') echo 'style="color:green;"'; else echo'style="color:red;"'; ?> href="<?php echo base_url().'admin/change-master-store-status/'.$row['id']; ?>"><?php echo ucfirst($row['is_active']); ?></a></td>
									<td><a class="label brown" href="<?php echo base_url('admin/update-master-store').'/'. $row['id']; ?>">Edit</a>
                    <a class="label red" href="#" onclick="confirm_modal('<?php echo base_url('admin/delete-master-store').'/'.$row['id'];?>');">Delete</a>
                  </td>
