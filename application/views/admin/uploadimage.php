        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/upload-image", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  

					<div class="item form-group">
                        <label class="col-md-12" for="title">Select Image </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
