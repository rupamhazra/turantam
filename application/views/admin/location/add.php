        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php
                    echo form_open_multipart(base_url() . "admin/add-location", array("class" => "form-horizontal form-label-left", "name" => "Login_Form"));
                    ?>  
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputLatitude" id="inputLatitude" class="form-control">
                        </div>
                    </div>
                     <div class="item form-group">
                        <label class="col-md-12" for="title">Longitude</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="text" name="inputLongitude" id="inputLongitude" class="form-control">
                        </div>
                    </div>
